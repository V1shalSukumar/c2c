...
# Kivy imports have been removed as per your request.
...
class AdvancedKineticCanvas:
    ...
    def get_frame(self):
        ...
        # Check and draw virtual icons on the blended frame
        self.check_icon_touches(self.current_extended_fingers)
        self.draw_icons(blended_frame)
        self.draw_ui(blended_frame)

        # Draw the hand landmarks (optional, but useful for feedback)
        if hand_results.multi_hand_landmarks:
            for hand_landmarks in hand_results.multi_hand_landmarks:
                mp.solutions.drawing_utils.draw_landmarks(
                    blended_frame, hand_landmarks, mp.solutions.hands.HAND_CONNECTIONS)
